			...
			<div class="span9">
				<?php
					if(isset($_GET['course_action']))
					{
							...
							$query=mysqli_query($connection,"SELECT * FROM class WHERE class_id='$act' ORDER BY course_code ASC");
					...
					else
					{
						if(isset($_POST['withdraw']))
						{
							...
							//now add to database
							//$query = mysqli_query("UPDATE courses SET course_name='$course_name', credit='$credit', description='$description' WHERE course_code='$course_code'") or die(mysqli_error());
