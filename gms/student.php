...
if (isset($_POST['add'])) {
    ...
    $q                    = mysqli_query($connection, "INSERT INTO `gms`.`class` (`class_name`,`batch`,`level`,`course_detail`) VALUES('$class->class_name','$class->batch','$class->level','$class->course_detail')") or die(mysqli_error($connection));
