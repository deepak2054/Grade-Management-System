			...
			<div class="row-fluid">
				...
				<?php
					if(isset($_POST['update']))
					{
						...
						//now add to database
						$query = mysql_query($connection,"UPDATE courses SET course_name='$course_name', credit='$credit', description='$description' WHERE course_code='$course_code'") or die(mysql_error($connection));
						if($query)
						{
