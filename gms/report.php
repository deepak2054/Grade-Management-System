	 ...
	 <body>
		...
		<div class="row-fluid">
			...
			<?php
				...
				while($row=mysqli_fetch_array($result))//assigning values to the array created
					{
			...
			<?php
				...
				{
					$act=$_GET['action'];
					if($act=='view_individual' or $act=='view_individual_error' or  $act=='view_selection_error' or  $act=='view_selection_errors')
					{
